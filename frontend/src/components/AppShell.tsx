...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  const ambientNoise =
    "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 160 160'><filter id='n' x='-20%25' y='-20%25' width='140%25' height='140%25'><feTurbulence type='fractalNoise' baseFrequency='0.75' numOctaves='2' stitchTiles='stitch'/></filter><rect width='100%25' height='100%25' filter='url(%23n)' opacity='0.14'/></svg>\")"

  return (
    <div className="relative min-h-screen text-slate-100">
      <div className="pointer-events-none fixed inset-0 opacity-40" style={{ backgroundImage: ambientGradient }} />
      <div className="pointer-events-none fixed inset-0" style={{ backgroundImage: ambientNoise }} />
